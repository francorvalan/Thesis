var LST_Process = function(x) {
  ...
  */
  ...
  QC_mask_Day = QC_mask_Day.filter(ee.Filter.gte(1))
  QC_mask_Night = QC_mask_Night.filter(ee.Filter.gte(1))
  ...
  var mask = (QC_mask_Night.and(QC_mask_Night)).rename('mask'); // combining the Day and Night Temperature
